'use strict';
/* build-hook-start *//*00001*/try { require('/Users/lucaswillian/.vscode/extensions/wallabyjs.console-ninja-1.0.359/out/buildHook/index.js').default({tool: 'jest', checkSum: '204a0d9146def970bbdf7fBlgeUxcBDlQHBAIKAAgAVwUFBwVW', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/lucaswillian/.vscode/extensions/wallabyjs.console-ninja-1.0.359/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '204a0d9146def970bbdf7fBlgeUxcBDlQHBAIKAAgAVwUFBwVW', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
